...
[![Charts](https://img.shields.io/badge/Charts-22-green)](charts/)
...
- **22 Production Charts** — Productivity, networking, monitoring, database,
  and privacy tools
...
| [onetimesecret](charts/onetimesecret/)     | Expiring, view-once secret sharing        |
| [open-webui](charts/open-webui/)           | Multi-model AI chat front-end             |
| [postgresql](charts/postgresql/)           | Single-node PostgreSQL (official image)   |
...
| [snapotter](charts/snapotter/)             | File processing platform                  |
| [stirling-pdf](charts/stirling-pdf/)       | PDF tools and document management         |
| [valkey](charts/valkey/)                   | Single-node Valkey (official image)       |
...
```text
helm-charts/
├── charts/                    # Helm charts (22 production-ready)
│   └── <chart-name>/
...
| ------------ | ------------------------------------------------------- |
| **Charts**   | 19 production-ready charts across 5 categories          |
